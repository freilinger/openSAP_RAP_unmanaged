CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS rba_Booking FOR READ
      IMPORTING keys_rba FOR READ Travel\_Booking
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrap_sfh_travel_x( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_RAP_SFH_Travel_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_RAP_SFH_Travel_U IMPLEMENTATION.
