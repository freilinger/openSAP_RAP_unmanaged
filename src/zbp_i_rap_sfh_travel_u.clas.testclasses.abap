*"* use this source file for your ABAP unit test classes
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE ZI_RAP_SFH_Travel_U\\travel.
      ...
      MODIFY ENTITIES OF ZI_RAP_SFH_Travel_U
        ENTITY travel
      ...
      SELECT * FROM ZI_RAP_SFH_Travel_U WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zi_rap_sfh_travel_u' )
                                    ( i_for_entity = 'zi_rap_sfh_booking_u' ) )
                                ).
    ENDMETHOD.
